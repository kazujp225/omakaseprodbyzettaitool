  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        {toast.message && (
          <p className="mt-1 text-sm text-navy-500">{toast.message}</p>
        )}
      </div>
      <button
        onClick={handleClose}
        className="flex-shrink-0 p-1 -mr-1 -mt-1 text-gray-400 hover:text-navy-500 transition-colors rounded-full hover:bg-white/50"
      >
